...
_TOLERATION = _descriptor.Descriptor(
  name='Toleration',
  full_name='api.Toleration',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='effect', full_name='api.Toleration.effect', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='key', full_name='api.Toleration.key', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='operator', full_name='api.Toleration.operator', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='api.Toleration.value', index=3,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_WORKERCONFIG_ANNOTATIONSENTRY = _descriptor.Descriptor(
  name='AnnotationsEntry',
  full_name='api.WorkerConfig.AnnotationsEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='api.WorkerConfig.AnnotationsEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='api.WorkerConfig.AnnotationsEntry.value', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_WORKERCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='cpu', full_name='api.WorkerConfig.cpu', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='memory', full_name='api.WorkerConfig.memory', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='scheduler', full_name='api.WorkerConfig.scheduler', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='mount', full_name='api.WorkerConfig.mount', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pull_secret', full_name='api.WorkerConfig.pull_secret', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='annotations', full_name='api.WorkerConfig.annotations', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tolerations', full_name='api.WorkerConfig.tolerations', index=9,
  ...
  nested_types=[_WORKERCONFIG_ANNOTATIONSENTRY, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
...
_WORKERCONFIG_ANNOTATIONSENTRY.containing_type = _WORKERCONFIG
_WORKERCONFIG.fields_by_name['mount'].message_type = _MOUNTCONF
_WORKERCONFIG.fields_by_name['annotations'].message_type = _WORKERCONFIG_ANNOTATIONSENTRY
_WORKERCONFIG.fields_by_name['tolerations'].message_type = _TOLERATION
...
Toleration = _reflection.GeneratedProtocolMessageType('Toleration', (_message.Message,), dict(
  ...
  __module__ = 'api_pb2'
  # @@protoc_insertion_point(class_scope:api.Toleration)
  ))
...
WorkerConfig = _reflection.GeneratedProtocolMessageType('WorkerConfig', (_message.Message,), dict(
  ...
  AnnotationsEntry = _reflection.GeneratedProtocolMessageType('AnnotationsEntry', (_message.Message,), dict(
    DESCRIPTOR = _WORKERCONFIG_ANNOTATIONSENTRY,
    __module__ = 'api_pb2'
    # @@protoc_insertion_point(class_scope:api.WorkerConfig.AnnotationsEntry)
    ))
  ,
...
_sym_db.RegisterMessage(WorkerConfig.AnnotationsEntry)
...
_WORKERCONFIG_ANNOTATIONSENTRY.has_options = True
_WORKERCONFIG_ANNOTATIONSENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
...
_MANAGER = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002#\022!/api/Manager/StopStudy/{study_id}')),
  ),
  _descriptor.MethodDescriptor(
    name='GetStudy',
  ...
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\032\"\025/api/Manager/RunTrial:\001*')),
  ),
  _descriptor.MethodDescriptor(
    name='StopWorkers',
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\035\"\030/api/Manager/StopWorkers:\001*')),
  ),
  _descriptor.MethodDescriptor(
    name='GetWorkers',
  ...
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002 \"\033/api/Manager/SaveStudyReply:\001*')),
  ),
  _descriptor.MethodDescriptor(
    name='SaveModel',
...
_SUGGESTION = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    input_type=_GETSUGGESTIONSREQUEST,
    output_type=_GETSUGGESTIONSREPLY,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002#\"\036/api/Suggestion/GetSuggestions:\001*')),
  ),
])
