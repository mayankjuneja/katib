...
_WORKERCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='annotations', full_name='api.WorkerConfig.annotations', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tolerations', full_name='api.WorkerConfig.tolerations', index=7,
